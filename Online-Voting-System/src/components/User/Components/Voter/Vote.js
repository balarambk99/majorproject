...
export default function CustomizedTables() {
    ...
    useEffect(() => {
        ...
        // console.log(token);
        //alert(id);
        axios.get(`${BASE_URL}/voter/getVoter/${id}`,{
            headers: {
                "Authorization": `Bearer ${token}`
            }
    ...
    const handleVote = (id) => {
        ...
        if (voter.voteStatus==="Voted") {
            ...
            const vote={
                ...
                candidatename:id.fullName,
                party:id.party
            }
            console.log(vote);
            axios.post(`${BASE_URL}/voter/giveVote`,vote,{
                headers: {
                      "Authorization": `Bearer ${token}`
                }
            })
                            ...
                            {candidate.map((row) => (
                                ...
                                <StyledTableRow key={row.name}>
                                    ...
                                    <StyledTableCell align="right" className="voteButton">
                                        <Button variant="contained" className="voteButton" onClick={() => handleVote({fullName:row.fullName,party:row.party})}>Vote</Button>
                                    </StyledTableCell>
                                </StyledTableRow>
                            ))}
                        </TableBody>
